...
export default function BernardNetworkPage() {
      ...
      <main className="klb-page-content klb-container py-8">
        ...
        <div className="mb-8 text-center">
          <h1 className="text-4xl font-bold text-gray-800 mb-4">
            🔗 Réseau LinkedIn de Bernard Laurent-Bellue
          </h1>
          <p className="text-lg klb-text-muted max-w-2xl mx-auto">
            Gestion et analyse des connexions LinkedIn de Bernard pour la campagne électorale
          </p>
          {loading && (
          ...
          <div className="klb-grid klb-grid-responsive mb-8">
            <div className="klb-card">
              <div className="klb-card-body text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-700">Connexions Bernard</h3>
            ...
            <div className="klb-card">
              <div className="klb-card-body text-center">
                ...
                <p className="klb-text-small">Aussi connectés à Sabine</p>
              </div>
            </div>
